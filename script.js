...
const svgIcons = [
  ...
  // Play and pause SVG icons for the music player
  ...
  function createFloatingIcons() {
    const numIcons = 200 // Increased from 50 to 200 to fill the screen
    ...
    for (let i = 0; i < numIcons; i++) {
      ...
      // Random size (slightly smaller on average for more icons)
  ...
  function initMusicPlayer() {
    ...
    // Play music when loaded - with better error handling
    ...
    // Add ended listener to debug if music is ending prematurely
    ...
    // Add stalled and suspended listeners
    ...
    // Play/Pause button with improved handling
  ...
  // FiveM loading progress handler
